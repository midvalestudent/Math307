...
% function to change from double to single indexing
% Note: if a function does not start on the first line of a file,
% the filename does not have to match the name of the function.
